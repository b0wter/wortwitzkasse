...
var $author$project$Main$emptyModel = {countF: 0, countJ: 0};
...
var $author$project$Main$constructCookie = function (_v0) {
	var f = _v0.a;
	var j = _v0.b;
	return 'F=' + ($elm$core$String$fromInt(f) + ('|J=' + $elm$core$String$fromInt(j)));
};
var $author$project$Main$modelToCookie = function (model) {
	return $author$project$Main$constructCookie(
		_Utils_Tuple2(model.countF, model.countJ));
};
		...
		switch (msg.$) {
			case 'IncrementF':
				var updatedModel = _Utils_update(
					model,
					{countF: model.countF + 1});
				return _Utils_Tuple2(
					updatedModel,
					$author$project$Main$setCookie(
						$author$project$Main$modelToCookie(updatedModel)));
			case 'IncrementJ':
				var updatedModel = _Utils_update(
					model,
					{countJ: model.countJ + 1});
				return _Utils_Tuple2(
					updatedModel,
					$author$project$Main$setCookie(
						$author$project$Main$modelToCookie(updatedModel)));
			...
			default:
				var text = msg.a;
				var _v1 = $author$project$Main$deconstructCookie(text);
				var f = _v1.a;
				var j = _v1.b;
				return _Utils_Tuple2(
					_Utils_update(
...
var $author$project$Main$IncrementF = {$: 'IncrementF'};
var $author$project$Main$IncrementJ = {$: 'IncrementJ'};
...
var $author$project$Main$counterRow = F4(
	function (name, total, count, msg) {
		var value = (!count) ? 0 : ((count / total) * 100.0);
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				...
				[
					...
					_List_fromArray(
						[
							...
							$rundis$elm_bootstrap$Bootstrap$Grid$col,
							_List_fromArray(
								[$rundis$elm_bootstrap$Bootstrap$Grid$Col$xs8, $rundis$elm_bootstrap$Bootstrap$Grid$Col$md9]),
							_List_fromArray(
								[
...
var $author$project$Main$view = function (model) {
	var total = model.countF + model.countJ;
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				A4($author$project$Main$counterRow, 'F', total, model.countF, $author$project$Main$IncrementF),
				A4($author$project$Main$counterRow, 'J', total, model.countJ, $author$project$Main$IncrementJ),
				A2(
				$rundis$elm_bootstrap$Bootstrap$Grid$row,
				_List_Nil,
				_List_fromArray(
